...
// recompute is idempotent: delete-all + reinsert), so this is a performance
// concern, not a correctness one. If user count approaches that, consider
// lowering the stagger, increasing the cron interval, or switching to bounded
// batches with a continuation cursor.
